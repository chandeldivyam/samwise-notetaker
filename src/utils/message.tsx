...
const MessageContext = createContext<{ message: MessageInstance | null }>({ message: null });

export const useMessage = () => {
  const { message } = useContext(MessageContext);
  if (!message) throw new Error('useMessage must be used within a MessageProvider');
  return message;
};
