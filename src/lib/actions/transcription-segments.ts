...
export async function processDeepgramTranscription(recordingId: string, deepgramResponse: Recording["transcription"]) {
...
export async function updateSegmentSpeaker(segmentId: string, personId: string | null) {
    const supabase = await createClient();
