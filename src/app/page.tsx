        ...
        <Col xs={24} sm={20} md={16} lg={12} className="text-center">
          <Space direction="vertical" size="large" className="w-full">
            ...
            <Paragraph className="text-lg">
              A simple and powerful note-taking application that helps you organize your thoughts, 
              ideas, and tasks in one place. Start writing and organizing your notes today!
            </Paragraph>
