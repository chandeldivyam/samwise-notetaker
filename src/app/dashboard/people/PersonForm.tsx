...
interface PersonFormProps {
    ...
    onSubmit: (values: FormValues) => Promise<{ error?: string; details?: string }>;
    submitButtonText: string;
}

export default function PersonForm({ initialPerson, onSubmit, submitButtonText }: PersonFormProps) {
    ...
    const onFinish = async (values: FormValues) => {
        ...
        try {
            ...
            if (error) {
                showError(message, `Failed to save person: ${details || error}`);
                return;
            }

            showSuccess(message, `Person ${initialPerson ? 'updated' : 'created'} successfully`);
